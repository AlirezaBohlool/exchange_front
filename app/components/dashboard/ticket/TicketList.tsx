                ...
                >
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-4">
                      ...
                      <div className="flex items-start gap-3 mb-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 mb-2">
                            <h3 className={`text-lg lg:text-xl font-semibold mb-0 font-[var(--font-morabba)] line-clamp-1 ${
                              ticket.unread_count && ticket.unread_count > 0 ? 'text-gray-900' : 'text-gray-900'
                            }`}>
                    ...
                    <div className="flex lg:flex-col items-center lg:items-end gap-2 lg:gap-3">
                      <div className={`w-3 h-3 rounded-full lg:order-1 ${
                        ticket.unread_count && ticket.unread_count > 0 
